...
This is a simple application that allows business owners to manage discounts for their customers. The app is built using React-Native, Expo and react-native-paper.
...
For the purposes of this exercise, you can run the app via Expo GO on either ios or android by pressing either `i` or `a`.
